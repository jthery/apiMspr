...
describe('Tests concernant les coupons', function () {
    ...
    describe('return get coupon by code_coupon', function () {
        it('Vérifie qu\'il y a chaque propriété pour le get /couponByCodeCoupon', function () {
            api.get(`${CONFIG.uri_prefix_main}/couponByCodeCoupon`)
                .expect(200)
                .end(function (err, res) {
                    expect(res.status).to.equal(200);
                    expect(res.body[0]).to.have.property('couponId');
